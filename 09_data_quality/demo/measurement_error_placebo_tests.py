...
print("  outputs/figures/measurement_error_tau_vs_sigma.png")
print("  outputs/figures/measurement_error_beta_vs_sigma.png")
print("  outputs/figures/permutation_placebo_tau_hist.png")
###############################################################################
